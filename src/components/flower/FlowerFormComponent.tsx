...
const FlowerFormComponent = forwardRef(
    ({ onCloseModal }: { onCloseModal: () => void }, ref
    ) => {
        ...
        return (
            <>
                <form
                    className="mx-auto mt-0 p-6 rounded-lg border-2 border-[#005b83] shadow-lg bg-[#003b5c]"
                    style={{
                        width: "100%", // Adjust form width
                        maxWidth: "700px", // Increased width for bigger modal
                    }}
                >
                    <div className="grid gap-6 mb-6 md:grid-cols-2">
                        <div>
                            <label htmlFor="flower_code" className="block mb-2 text-sm font-bold text-white">
                                Code
                            </label>
                            <input
                                type="text"
                                ...
                                className="w-full p-1 border border-[#005b83] rounded bg-[#c1d8e2] focus:outline-none shadow-md"
                                placeholder="01"
                                required
                            />
                        </div>
                        <div>
                            <label htmlFor="flower_name" className="block mb-2 text-sm font-bold text-white">
                                Name
                            </label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label htmlFor="flower_colour" className="block mb-2 text-sm font-bold text-white">
                                Colour
                            </label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label htmlFor="flower_quality" className="block mb-2 text-sm font-bold text-white">
                                Quality
                            </label>
                            <select
                                id="flower_quality"
                                className="w-full p-1 border border-[#005b83] text-md rounded bg-[#c1d8e2] focus:outline-none shadow-md"
                                value={flowerQuality}
                        ...
                        <div>
                            <label htmlFor="flower_seller" className="block mb-2 text-sm font-bold text-white">
                                Seller
                            </label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label htmlFor="flower_image" className="block mb-2 text-sm font-bold text-white">
                                Image
                            </label>
                            <input
                                type="file"
                                ...
                                className="w-full p-1.5 text-xs border border-[#005b83] rounded bg-[#c1d8e2] shadow-md"
                                accept="image/*"
                            />
                            {previewFlowerImage && (
