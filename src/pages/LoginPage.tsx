...
function LoginPage() {
    ...
    const handleSignIn = (event: React.FormEvent) => {
        ...
        // For demonstration purposes, we'll directly navigate to dashboard

        if (email && password) { // Optional: You can add simple validation here
        ...
        <>
            <div className="flex justify-center items-center min-h-screen bg-gray-100">
                <div
                    ...
                    style={{ width: '1000px', height: '700px' }} // Increased width of the green div
                >
                                ...
                                <form className="space-y-6" onSubmit={handleSignIn}>
                                    ...
                                    <div>
                                        ...
                                        <button
                                            ...
                                            onClick={() => navigate("/signup")} // Optional: Add navigation for signup
                                        >
                                            Create account
                                        </button>
                                    </div>
